...
/** @constructor */
function $c_Lme_mfransen_AssetManager() {
  $c_O.call(this);
  this.document$1 = null;
  this.div$1 = null;
  this.assets$1 = null
}
$c_Lme_mfransen_AssetManager.prototype = new $h_O();
$c_Lme_mfransen_AssetManager.prototype.constructor = $c_Lme_mfransen_AssetManager;
/** @constructor */
function $h_Lme_mfransen_AssetManager() {
  /*<skip>*/
}
$h_Lme_mfransen_AssetManager.prototype = $c_Lme_mfransen_AssetManager.prototype;
$c_Lme_mfransen_AssetManager.prototype.init___Lorg_scalajs_dom_raw_Document = (function(document) {
  this.document$1 = document;
  this.div$1 = document["createElement"]("div");
  this.div$1["style"]["display"] = "none";
  document["getElementsByTagName"]("body")[0]["appendChild"](this.div$1);
  this.assets$1 = $as_scm_Map($m_scm_Map$().apply__sc_Seq__sc_GenMap($m_sci_Nil$()));
  return this
});
$c_Lme_mfransen_AssetManager.prototype.loadAsset__T__T__V = (function(name, file) {
  var img = this.document$1["createElement"]("img");
  img["id"] = name;
  img["src"] = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["assets/", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([file]));
  this.assets$1.put__O__O__s_Option(name, img);
  this.div$1["appendChild"](img)
});
var $d_Lme_mfransen_AssetManager = new $TypeData().initClass({
  Lme_mfransen_AssetManager: 0
}, false, "me.mfransen.AssetManager", {
  Lme_mfransen_AssetManager: 1,
  O: 1
});
$c_Lme_mfransen_AssetManager.prototype.$classData = $d_Lme_mfransen_AssetManager;
/** @constructor */
function $c_Lme_mfransen_Board() {
  $c_O.call(this);
  this.me$mfransen$Board$$game$f = null;
  this.tiles$1 = null
}
$c_Lme_mfransen_Board.prototype = new $h_O();
$c_Lme_mfransen_Board.prototype.constructor = $c_Lme_mfransen_Board;
/** @constructor */
function $h_Lme_mfransen_Board() {
  /*<skip>*/
}
$h_Lme_mfransen_Board.prototype = $c_Lme_mfransen_Board.prototype;
$c_Lme_mfransen_Board.prototype.init___Lme_mfransen_Game = (function(game) {
  this.me$mfransen$Board$$game$f = game;
  var xs = $m_sci_Nil$();
  var len = $s_sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(xs);
  var array = $newArrayObject($d_Lme_mfransen_Tile.getArrayOf(), [len]);
  var elem$1 = 0;
  elem$1 = 0;
...
$c_Lme_mfransen_Board.prototype.getMove__I__Lme_mfransen_Move = (function(pos) {
  return (((pos >= 0) && (pos <= 9)) ? new $c_Lme_mfransen_Move().init___I__I__Z(((32 + $imul(64, pos)) | 0), 32, true) : (((pos >= 10) && (pos <= 18)) ? new $c_Lme_mfransen_Move().init___I__I__Z(609, ((32 + $imul(64, (((-9) + pos) | 0))) | 0), false) : (((pos >= 19) && (pos <= 27)) ? new $c_Lme_mfransen_Move().init___I__I__Z(((32 - $imul(64, (((-27) + pos) | 0))) | 0), 609, true) : (((pos >= 28) && (pos <= 35)) ? new $c_Lme_mfransen_Move().init___I__I__Z(32, ((32 - $imul(64, (((-36) + pos) | 0))) | 0), false) : null))))
});
$c_Lme_mfransen_Board.prototype.draw__V = (function() {
  var xs = this.tiles$1;
  var i = 0;
  var len = xs.u["length"];
  while ((i < len)) {
    var index = i;
    var arg1 = xs.u[index];
    var tile = $as_Lme_mfransen_Tile(arg1);
    if (tile.special$1) {
      var qual$1 = this.me$mfransen$Board$$game$f.context$1;
      var x$1 = this.me$mfransen$Board$$game$f.assets$1.assets$1.apply__O__O("tile-special");
      var x$2 = tile.x$1;
      var x$3 = tile.y$1;
    ...
    this.me$mfransen$Board$$game$f.context$1["lineWidth"] = 1.0;
    this.me$mfransen$Board$$game$f.context$1["strokeRect"](tile.x$1, tile.y$1, 64.0, 64.0);
    i = ((1 + i) | 0)
  }
});
$c_Lme_mfransen_Board.prototype.generate__V = (function() {
  var i = 0;
  var count = 0;
  while ((i !== 10)) {
    var v1 = i;
    this.tiles$1.u[v1] = new $c_Lme_mfransen_Tile().init___I__I__Z($imul(64, v1), 0, false);
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  };
  var i$1 = 10;
  ...
  while ((i$1 !== 19)) {
    var v1$1 = i$1;
    this.tiles$1.u[v1$1] = new $c_Lme_mfransen_Tile().init___I__I__Z(576, $imul(64, (((-9) + v1$1) | 0)), false);
    count$1 = ((1 + count$1) | 0);
    i$1 = ((1 + i$1) | 0)
  };
  var i$2 = 19;
  ...
  while ((i$2 !== 28)) {
    var v1$2 = i$2;
    this.tiles$1.u[v1$2] = new $c_Lme_mfransen_Tile().init___I__I__Z(((-$imul(64, (((-27) + v1$2) | 0))) | 0), 576, false);
    count$2 = ((1 + count$2) | 0);
    i$2 = ((1 + i$2) | 0)
  };
  var i$3 = 28;
  ...
  while ((i$3 !== 36)) {
    var v1$3 = i$3;
    this.tiles$1.u[v1$3] = new $c_Lme_mfransen_Tile().init___I__I__Z(0, ((-$imul(64, (((-36) + v1$3) | 0))) | 0), false);
    count$3 = ((1 + count$3) | 0);
    i$3 = ((1 + i$3) | 0)
  };
  this.tiles$1.u[0].special$1 = true;
  this.tiles$1.u[9].special$1 = true;
  this.tiles$1.u[18].special$1 = true;
  this.tiles$1.u[27].special$1 = true
});
var $d_Lme_mfransen_Board = new $TypeData().initClass({
  Lme_mfransen_Board: 0
}, false, "me.mfransen.Board", {
  Lme_mfransen_Board: 1,
  O: 1
});
$c_Lme_mfransen_Board.prototype.$classData = $d_Lme_mfransen_Board;
/** @constructor */
function $c_Lme_mfransen_Game() {
  $c_O.call(this);
  this.window$1 = null;
  this.document$1 = null;
  this.canvas$1 = null;
  ...
  this.alpha$1 = 0;
  this.players$1 = null;
  this.tileFrequency$1 = 0;
  this.currentDie$1 = 0;
  this.random$1 = null;
  this.rolls$1 = 0;
  this.board$1 = null;
  this.dieDone$1 = false;
  this.currentPlayer$1 = 0;
  this.task$1 = 0;
  this.isPrompted$1 = false;
  this.currentQuestion$1 = 0;
  this.questions$1 = null;
  this.sources$1 = null
}
$c_Lme_mfransen_Game.prototype = new $h_O();
$c_Lme_mfransen_Game.prototype.constructor = $c_Lme_mfransen_Game;
/** @constructor */
function $h_Lme_mfransen_Game() {
  /*<skip>*/
}
$h_Lme_mfransen_Game.prototype = $c_Lme_mfransen_Game.prototype;
$c_Lme_mfransen_Game.prototype.cyclePlayer__I__Z = (function(initial) {
  this.currentPlayer$1 = ((1 + this.currentPlayer$1) | 0);
  var jsx$1 = this.currentPlayer$1;
  var this$1 = this.players$1;
  if ((jsx$1 >= this$1.size0$6)) {
    this.currentPlayer$1 = 0
  };
  var this$2 = this.players$1;
  var idx = this.currentPlayer$1;
  if (((!$as_Lme_mfransen_Player($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$2, idx)).alive$1) && (this.currentPlayer$1 !== initial))) {
    this.cyclePlayer__I__Z(initial)
  };
  return (this.currentPlayer$1 === initial)
});
$c_Lme_mfransen_Game.prototype.init__V = (function() {
  this.loadAssets__V();
  this.loadQuestion__V();
  this.board$1.generate__V();
  this.canvas$1["onclick"] = (function(arg$outer) {
    return (function(e$2) {
      arg$outer.click__Lorg_scalajs_dom_raw_Event__V(e$2)
    })
  })(this);
  this.task$1 = $uI($g["setInterval"]((function(arg$outer$1) {
    return (function() {
      arg$outer$1.update__V()
    })
  })(this), 50.0))
});
$c_Lme_mfransen_Game.prototype.click__Lorg_scalajs_dom_raw_Event__V = (function(e) {
  if (((((($uD(e["clientX"]) >= 272) && ($uD(e["clientY"]) >= 272)) && ($uD(e["clientX"]) <= 368)) && ($uD(e["clientY"]) <= 368)) && (!this.isPrompted$1))) {
    if (this.dieDone$1) {
      this.rolls$1 = 16;
      this.dieDone$1 = false
    }
  } else if (((this.isPrompted$1 && ($uD(e["clientX"]) >= 104)) && ($uD(e["clientY"]) <= 536))) {
    if ((($uD(e["clientY"]) >= 224) && ($uD(e["clientY"]) <= 260))) {
      this.promptFinish__T__V("a")
    } else if ((($uD(e["clientY"]) >= 274) && ($uD(e["clientY"]) <= 308))) {
      this.promptFinish__T__V("b")
    } else if ((($uD(e["clientY"]) >= 324) && ($uD(e["clientY"]) <= 360))) {
      this.promptFinish__T__V("c")
    } else if ((($uD(e["clientY"]) >= 374) && ($uD(e["clientY"]) <= 408))) {
      this.promptFinish__T__V("d")
    }
  }
});
$c_Lme_mfransen_Game.prototype.getLastPlayer__Lme_mfransen_Player = (function() {
  ...
  try {
    ...
    while ((i < top)) {
      ...
      var player = $as_Lme_mfransen_Player(arg1);
      if (player.alive$1) {
        throw new $c_sr_NonLocalReturnControl().init___O__O(nonLocalReturnKey1, player)
      };
      i = ((1 + i) | 0)
    };
    return null
    ...
    if ($is_sr_NonLocalReturnControl(e)) {
      ...
      if ((ex.key$2 === nonLocalReturnKey1)) {
        return $as_Lme_mfransen_Player(ex.value$f)
      } else {
        throw ex
      }
    } else {
...
$c_Lme_mfransen_Game.prototype.getAlive__I = (function() {
  var elem$1 = 0;
  elem$1 = 0;
  var this$2 = this.players$1;
  var i = 0;
...
$c_Lme_mfransen_Game.prototype.init___Lorg_scalajs_dom_raw_Window = (function(window) {
  this.window$1 = window;
  this.document$1 = window["document"];
  this.canvas$1 = this.document$1["getElementById"]("game");
  this.context$1 = this.canvas$1["getContext"]("2d");
  this.assets$1 = new $c_Lme_mfransen_AssetManager().init___Lorg_scalajs_dom_raw_Document(this.document$1);
  this.alpha$1 = 0;
  this.players$1 = $as_scm_ArrayBuffer($m_scm_ArrayBuffer$().apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  this.tileFrequency$1 = 4;
  this.currentDie$1 = 1;
  this.random$1 = $m_s_util_Random$();
  this.rolls$1 = 0;
  this.board$1 = new $c_Lme_mfransen_Board().init___Lme_mfransen_Game(this);
  this.dieDone$1 = true;
  this.currentPlayer$1 = 0;
  this.task$1 = 0;
  this.isPrompted$1 = false;
  this.currentQuestion$1 = 0;
  this.questions$1 = $as_scm_ArrayBuffer($m_scm_ArrayBuffer$().apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  this.sources$1 = $as_scm_ArrayBuffer($m_scm_ArrayBuffer$().apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  return this
});
$c_Lme_mfransen_Game.prototype.loadQuestion__V = (function() {
  var this$2 = this.questions$1;
  var elem = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "Approximately how many deaths are caused by smoking each year in the United States?(\"Health Effects\")", "480,000,000", "480", "480,000", "48,000", "c");
  ...
  var this$6 = this.questions$1;
  var elem$2 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "About how many deaths from COPD are caused by smoking?(\"Health Effects\")", "8 out of 10", "25%", "1/3", "2", "a");
  var this$5 = $m_scm_ArrayBuffer$();
  var bf$2 = this$5.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$6, elem$2, bf$2));
  var this$8 = this.questions$1;
  var elem$3 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "Smoking is estimated to increase the risk for stroke by(\"Health Effects\")", "1-2 times", "2-3 times", "3-4 times", "2-4 times", "d");
  var this$7 = $m_scm_ArrayBuffer$();
  var bf$3 = this$7.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$8, elem$3, bf$3));
  var this$10 = this.questions$1;
  var elem$4 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "Just after x many year(s) of smoking risk of heart attack your risk of heart attack drops sharply(\"Health Effects\")", "2", "1", "4", "5", "b");
  var this$9 = $m_scm_ArrayBuffer$();
  var bf$4 = this$9.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$10, elem$4, bf$4));
  var this$12 = this.questions$1;
  var elem$5 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "Number of alcoholic liver disease deaths(\"Alcohol\")", "18,146", "18,000", "23,618", "15,000", "a");
  var this$11 = $m_scm_ArrayBuffer$();
  var bf$5 = this$11.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$12, elem$5, bf$5));
  var this$14 = this.questions$1;
  var elem$6 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "Number of alcohol-induced deaths, excluding accidents and homicides(\"Alcohol\")", "29,001", "30,000", "15,583", "32,000", "a");
  var this$13 = $m_scm_ArrayBuffer$();
  var bf$6 = this$13.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$14, elem$6, bf$6));
  var this$16 = this.questions$1;
  var elem$7 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "What BMI is considered overweight(\"Do\")", "17", "27", "30", "50", "b");
  var this$15 = $m_scm_ArrayBuffer$();
  var bf$7 = this$15.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$16, elem$7, bf$7));
  var this$18 = this.questions$1;
  var elem$8 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "What is the \"Target\" BMI(\"Do\")", "13.4-12", "12-18.5", "18.5-24.9", "24.9-50", "c");
  var this$17 = $m_scm_ArrayBuffer$();
  var bf$8 = this$17.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$18, elem$8, bf$8));
  var this$20 = this.questions$1;
  var elem$9 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "What is the \"Target\" Blood Pressure? (\"Do\")", "60/20 mm Hg", "120/30 mm Hg", "160/80 mm Hg", "120/80 mm Hg", "d");
  var this$19 = $m_scm_ArrayBuffer$();
  ...
  var this$24 = this.questions$1;
  var elem$11 = new $c_Lme_mfransen_Question().init___Lme_mfransen_Game__T__T__T__T__T__T(this, "Which of the following can cause high blood pressure?(\"copy\")", "Overweight", "alcohol consumption", "lack of physical exercise", "all of the above", "d");
  var this$23 = $m_scm_ArrayBuffer$();
  var bf$11 = this$23.ReusableCBFInstance$2;
  this.questions$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$24, elem$11, bf$11))
});
$c_Lme_mfransen_Game.prototype.draw__V = (function() {
  this.context$1["clearRect"](0.0, 0.0, 640.0, 640.0);
  this.board$1.draw__V();
  var this$1 = this.players$1;
  var i = 0;
  var top = this$1.size0$6;
  while ((i < top)) {
  ...
  var qual$1 = this.context$1;
  var x$1 = this.assets$1.assets$1.apply__O__O(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["dice", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.currentDie$1])));
  qual$1["drawImage"](x$1, 272.0, 272.0, 96.0, 96.0);
  if (this.isPrompted$1) {
    this.context$1["fillStyle"] = "lightGray";
    this.context$1["strokeStyle"] = "black";
    this.context$1["lineWidth"] = 1.0;
    this.context$1["fillRect"](96.0, 96.0, 448.0, 448.0);
    this.context$1["strokeRect"](96.0, 96.0, 448.0, 448.0);
    var this$4 = this.questions$1;
    var idx = this.currentQuestion$1;
    $as_Lme_mfransen_Question($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$4, idx)).draw__V()
  }
});
$c_Lme_mfransen_Game.prototype.prompt__V = (function() {
  var this$2 = this.random$1;
  var this$1 = this.questions$1;
  var n = this$1.size0$6;
  this.currentQuestion$1 = this$2.self$1.nextInt__I__I(n);
  this.isPrompted$1 = true
});
$c_Lme_mfransen_Game.prototype.promptFinish__T__V = (function(result) {
  this.isPrompted$1 = false;
  var this$1 = this.questions$1;
  var idx = this.currentQuestion$1;
  if ((result === $as_Lme_mfransen_Question($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$1, idx)).correct$1)) {
    var jsx$1 = this.board$1.tiles$1;
    var this$2 = this.players$1;
    var idx$1 = this.currentPlayer$1;
    jsx$1.u[$as_Lme_mfransen_Player($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$2, idx$1)).position$1].owner$1 = this.currentPlayer$1;
    this.window$1["alert"]("Correct!")
  } else {
    var jsx$3 = this.window$1;
    var jsx$2 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Incorrect the answer is:\\n", ""]));
    var this$3 = this.questions$1;
    var idx$2 = this.currentQuestion$1;
    jsx$3["alert"](jsx$2.s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lme_mfransen_Question($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$3, idx$2)).getAnswerText__T()])))
  };
  this.cyclePlayer__I__Z(this.currentPlayer$1)
});
$c_Lme_mfransen_Game.prototype.update__V = (function() {
  this.alpha$1 = ((1 + this.alpha$1) | 0);
  if (((!this.dieDone$1) && ((this.alpha$1 % 2) === 0))) {
    var this$1 = this.random$1;
    this.currentDie$1 = ((1 + this$1.self$1.nextInt__I__I(6)) | 0);
    this.rolls$1 = (((-1) + this.rolls$1) | 0)
  };
  if (((!this.dieDone$1) && (this.rolls$1 === 0))) {
    this.dieDone$1 = true;
    var this$2 = this.players$1;
    var idx = this.currentPlayer$1;
    var newPos = (($as_Lme_mfransen_Player($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$2, idx)).position$1 + this.currentDie$1) | 0);
    if ((newPos >= 36)) {
      newPos = (((-36) + newPos) | 0)
    };
    var this$3 = this.players$1;
    var idx$1 = this.currentPlayer$1;
    $as_Lme_mfransen_Player($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$3, idx$1)).position$1 = newPos;
    var this$4 = this.players$1;
    var idx$2 = this.currentPlayer$1;
    $as_Lme_mfransen_Player($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$4, idx$2)).setPos__I__V(newPos)
  };
  if ((this.getAlive__I() === 1)) {
    this.window$1["alert"](new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", " Wins"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.getLastPlayer__Lme_mfransen_Player().name$1])));
    this.window$1["close"]();
    $g["clearInterval"](this.task$1)
  };
  this.draw__V()
});
$c_Lme_mfransen_Game.prototype.loadAssets__V = (function() {
  this.assets$1.loadAsset__T__T__V("tile", "tile.png");
  this.assets$1.loadAsset__T__T__V("tile-special", "tile-special.png");
  var i = 1;
  var count = 0;
  while ((i !== 7)) {
    var v1 = i;
    this.assets$1.loadAsset__T__T__V(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["dice", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([v1])), new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["dice-", ".png"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([v1])));
    count = ((1 + count) | 0);
    i = ((1 + i) | 0)
  }
});
var $d_Lme_mfransen_Game = new $TypeData().initClass({
  Lme_mfransen_Game: 0
}, false, "me.mfransen.Game", {
  Lme_mfransen_Game: 1,
  O: 1
});
$c_Lme_mfransen_Game.prototype.$classData = $d_Lme_mfransen_Game;
/** @constructor */
function $c_Lme_mfransen_Move() {
  $c_O.call(this);
  this.x$1 = 0;
  this.y$1 = 0;
  this.xFirst$1 = false
}
$c_Lme_mfransen_Move.prototype = new $h_O();
$c_Lme_mfransen_Move.prototype.constructor = $c_Lme_mfransen_Move;
/** @constructor */
function $h_Lme_mfransen_Move() {
  /*<skip>*/
}
$h_Lme_mfransen_Move.prototype = $c_Lme_mfransen_Move.prototype;
$c_Lme_mfransen_Move.prototype.init___I__I__Z = (function(_x, _y, _xFirst) {
  this.x$1 = _x;
  this.y$1 = _y;
  this.xFirst$1 = _xFirst;
  return this
});
var $d_Lme_mfransen_Move = new $TypeData().initClass({
  Lme_mfransen_Move: 0
}, false, "me.mfransen.Move", {
  Lme_mfransen_Move: 1,
  O: 1
});
$c_Lme_mfransen_Move.prototype.$classData = $d_Lme_mfransen_Move;
/** @constructor */
function $c_Lme_mfransen_Player() {
  $c_O.call(this);
  this.game$1 = null;
  this.x$1 = 0;
  this.y$1 = 0;
...
$c_Lme_mfransen_Player.prototype = new $h_O();
$c_Lme_mfransen_Player.prototype.constructor = $c_Lme_mfransen_Player;
/** @constructor */
function $h_Lme_mfransen_Player() {
  /*<skip>*/
}
$h_Lme_mfransen_Player.prototype = $c_Lme_mfransen_Player.prototype;
$c_Lme_mfransen_Player.prototype.init___Lme_mfransen_Game__T__T__I__I = (function(game, _name, _color, _x, _y) {
  this.game$1 = game;
  this.x$1 = _x;
  this.y$1 = _y;
  this.position$1 = 0;
...
$c_Lme_mfransen_Player.prototype.draw__V = (function() {
  if (this.alive$1) {
    this.game$1.context$1["beginPath"]();
    this.game$1.context$1["arc"](this.x$1, this.y$1, 24.0, 0.0, 6.283185307179586);
    this.game$1.context$1["fillStyle"] = "black";
    this.game$1.context$1["strokeStyle"] = "black";
    this.game$1.context$1["lineWidth"] = 4.0;
    this.game$1.context$1["fill"]();
    this.game$1.context$1["stroke"]();
    var jsx$1 = this.game$1.context$1;
    var s = this.color$1;
    jsx$1["fillStyle"] = s;
    this.game$1.context$1["beginPath"]();
    this.game$1.context$1["arc"](this.x$1, this.y$1, $imul(3, this.size$1), 0.0, 6.283185307179586);
    this.game$1.context$1["lineWidth"] = 0.0;
    this.game$1.context$1["fill"]()
  }
});
$c_Lme_mfransen_Player.prototype.setPos__I__V = (function(pos) {
  var mov = this.game$1.board$1.getMove__I__Lme_mfransen_Move(pos);
  this.x$1 = mov.x$1;
  this.y$1 = mov.y$1;
  if (this.game$1.board$1.tiles$1.u[pos].special$1) {
    this.size$1 = ((3 + this.size$1) | 0);
    var this$1 = this.game$1;
    this$1.cyclePlayer__I__Z(this$1.currentPlayer$1)
  } else if ((this.game$1.board$1.tiles$1.u[pos].owner$1 === (-1))) {
    var jsx$1 = this.game$1.board$1.tiles$1.u[pos];
    var this$2 = this.game$1.players$1;
    jsx$1.owner$1 = $s_sc_GenSeqLike$class__indexOf__sc_GenSeqLike__O__I__I(this$2, this, 0);
    var this$3 = this.game$1;
    this$3.cyclePlayer__I__Z(this$3.currentPlayer$1)
  } else {
    var jsx$2 = this.game$1.board$1.tiles$1.u[pos].owner$1;
    var this$4 = this.game$1.players$1;
    if ((jsx$2 !== $s_sc_GenSeqLike$class__indexOf__sc_GenSeqLike__O__I__I(this$4, this, 0))) {
      this.size$1 = (((-1) + this.size$1) | 0);
      this.game$1.prompt__V();
      if ((this.size$1 === 0)) {
        this.alive$1 = false
      }
    } else {
      var jsx$3 = this.game$1.board$1.tiles$1.u[pos].owner$1;
      var this$5 = this.game$1.players$1;
      if ((jsx$3 === $s_sc_GenSeqLike$class__indexOf__sc_GenSeqLike__O__I__I(this$5, this, 0))) {
        this.size$1 = ((1 + this.size$1) | 0);
        var this$6 = this.game$1;
        this$6.cyclePlayer__I__Z(this$6.currentPlayer$1)
      }
    }
  };
  if ((this.size$1 > 8)) {
...
function $is_Lme_mfransen_Player(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lme_mfransen_Player)))
}
function $as_Lme_mfransen_Player(obj) {
  return (($is_Lme_mfransen_Player(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "me.mfransen.Player"))
}
function $isArrayOf_Lme_mfransen_Player(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lme_mfransen_Player)))
}
function $asArrayOf_Lme_mfransen_Player(obj, depth) {
  return (($isArrayOf_Lme_mfransen_Player(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lme.mfransen.Player;", depth))
}
var $d_Lme_mfransen_Player = new $TypeData().initClass({
  Lme_mfransen_Player: 0
}, false, "me.mfransen.Player", {
  Lme_mfransen_Player: 1,
  O: 1
});
$c_Lme_mfransen_Player.prototype.$classData = $d_Lme_mfransen_Player;
/** @constructor */
function $c_Lme_mfransen_Question() {
  $c_O.call(this);
  this.game$1 = null;
  this.text$1 = null;
  this.a$1 = null;
...
$c_Lme_mfransen_Question.prototype = new $h_O();
$c_Lme_mfransen_Question.prototype.constructor = $c_Lme_mfransen_Question;
/** @constructor */
function $h_Lme_mfransen_Question() {
  /*<skip>*/
}
$h_Lme_mfransen_Question.prototype = $c_Lme_mfransen_Question.prototype;
$c_Lme_mfransen_Question.prototype.getAnswerText__T = (function() {
  return ((this.correct$1 === "a") ? this.a$1 : ((this.correct$1 === "b") ? this.b$1 : ((this.correct$1 === "c") ? this.c$1 : ((this.correct$1 === "d") ? this.d$1 : ""))))
});
$c_Lme_mfransen_Question.prototype.draw__V = (function() {
  this.game$1.context$1["font"] = "16px Arial";
  this.game$1.context$1["fillStyle"] = "black";
  this.game$1.context$1["fillText"](this.text$1, 104.0, 120.0, 432.0);
  this.game$1.context$1["fillText"](new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["a) ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.a$1])), 104.0, 240.0, 432.0);
  this.game$1.context$1["fillText"](new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["b) ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.b$1])), 104.0, 290.0, 432.0);
  this.game$1.context$1["fillText"](new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["c) ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.c$1])), 104.0, 340.0, 432.0);
  this.game$1.context$1["fillText"](new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["d) ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.d$1])), 104.0, 390.0, 432.0)
});
$c_Lme_mfransen_Question.prototype.init___Lme_mfransen_Game__T__T__T__T__T__T = (function(game, text, a, b, c, d, correct) {
  this.game$1 = game;
  this.text$1 = text;
  this.a$1 = a;
  this.b$1 = b;
  this.c$1 = c;
  this.d$1 = d;
  this.correct$1 = correct;
  return this
});
function $is_Lme_mfransen_Question(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lme_mfransen_Question)))
}
function $as_Lme_mfransen_Question(obj) {
  return (($is_Lme_mfransen_Question(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "me.mfransen.Question"))
}
function $isArrayOf_Lme_mfransen_Question(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lme_mfransen_Question)))
}
function $asArrayOf_Lme_mfransen_Question(obj, depth) {
  return (($isArrayOf_Lme_mfransen_Question(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lme.mfransen.Question;", depth))
}
var $d_Lme_mfransen_Question = new $TypeData().initClass({
  Lme_mfransen_Question: 0
}, false, "me.mfransen.Question", {
  Lme_mfransen_Question: 1,
  O: 1
});
$c_Lme_mfransen_Question.prototype.$classData = $d_Lme_mfransen_Question;
/** @constructor */
function $c_Lme_mfransen_Tile() {
  $c_O.call(this);
...
$c_Lme_mfransen_Tile.prototype = new $h_O();
$c_Lme_mfransen_Tile.prototype.constructor = $c_Lme_mfransen_Tile;
/** @constructor */
function $h_Lme_mfransen_Tile() {
  /*<skip>*/
}
$h_Lme_mfransen_Tile.prototype = $c_Lme_mfransen_Tile.prototype;
$c_Lme_mfransen_Tile.prototype.init___I__I__Z = (function(_x, _y, _special) {
  this.special$1 = _special;
  this.x$1 = _x;
  this.y$1 = _y;
  this.owner$1 = (-1);
  return this
});
function $is_Lme_mfransen_Tile(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lme_mfransen_Tile)))
}
function $as_Lme_mfransen_Tile(obj) {
  return (($is_Lme_mfransen_Tile(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "me.mfransen.Tile"))
}
function $isArrayOf_Lme_mfransen_Tile(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lme_mfransen_Tile)))
}
function $asArrayOf_Lme_mfransen_Tile(obj, depth) {
  return (($isArrayOf_Lme_mfransen_Tile(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lme.mfransen.Tile;", depth))
}
var $d_Lme_mfransen_Tile = new $TypeData().initClass({
  Lme_mfransen_Tile: 0
}, false, "me.mfransen.Tile", {
  Lme_mfransen_Tile: 1,
  O: 1
});
$c_Lme_mfransen_Tile.prototype.$classData = $d_Lme_mfransen_Tile;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
/** @constructor */
function $c_Lme_mfransen_Launcher$() {
  $c_O.call(this);
...
/** @constructor */
function $h_Lme_mfransen_Launcher$() {
  /*<skip>*/
}
$h_Lme_mfransen_Launcher$.prototype = $c_Lme_mfransen_Launcher$.prototype;
$c_Lme_mfransen_Launcher$.prototype.init___ = (function() {
  $n_Lme_mfransen_Launcher$ = this;
...
$c_Lme_mfransen_Launcher$.prototype.$$js$exported$meth$addPlayer__Lorg_scalajs_dom_raw_MouseEvent__O = (function(event) {
  this.addPlayer__Lorg_scalajs_dom_raw_MouseEvent__V(event)
});
$c_Lme_mfransen_Launcher$.prototype.$$js$exported$meth$prompt__I__O = (function(message) {
  this.prompt__I__V(message)
});
$c_Lme_mfransen_Launcher$.prototype.kill__I__V = (function(player) {
  var this$1 = this.game$1.players$1;
  $as_Lme_mfransen_Player($s_scm_ResizableArray$class__apply__scm_ResizableArray__I__O(this$1, player)).alive$1 = false
});
$c_Lme_mfransen_Launcher$.prototype.launch__Lorg_scalajs_dom_raw_MouseEvent__V = (function(event) {
  var qual$1 = $g["document"];
  var gameWindow = qual$1["open"]("", "Game of Risks", "width=640,height=640");
  gameWindow["document"]["write"](this.windowHTML$1);
  this.game$1 = new $c_Lme_mfransen_Game().init___Lorg_scalajs_dom_raw_Window(gameWindow);
  var this$1 = this.players$1;
  var i = 0;
  var top = this$1.size0$6;
  while ((i < top)) {
    var arg1 = this$1.array$6.u[i];
    var player = $as_Lme_mfransen_Player(arg1);
    var ev$1 = $m_Lme_mfransen_Launcher$().game$1;
    var this$3 = ev$1.players$1;
    var elem = new $c_Lme_mfransen_Player().init___Lme_mfransen_Game__T__T__I__I($m_Lme_mfransen_Launcher$().game$1, player.name$1, player.color$1, player.x$1, player.y$1);
    var this$2 = $m_scm_ArrayBuffer$();
    var bf = this$2.ReusableCBFInstance$2;
    ev$1.players$1 = $as_scm_ArrayBuffer($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$3, elem, bf));
    i = ((1 + i) | 0)
  };
  this.game$1.init__V()
});
$c_Lme_mfransen_Launcher$.prototype.$$js$exported$meth$launch__Lorg_scalajs_dom_raw_MouseEvent__O = (function(event) {
  this.launch__Lorg_scalajs_dom_raw_MouseEvent__V(event)
});
$c_Lme_mfransen_Launcher$.prototype.$$js$exported$meth$main__O = (function() {
  return (void 0)
});
$c_Lme_mfransen_Launcher$.prototype.prompt__I__V = (function(message) {
  this.game$1.currentQuestion$1 = message;
  this.game$1.isPrompted$1 = true
});
$c_Lme_mfransen_Launcher$.prototype.addPlayer__Lorg_scalajs_dom_raw_MouseEvent__V = (function(event) {
  ...
  name["value"] = "";
  var qual$2 = $g["document"]["getElementById"]("players");
  qual$2["add"](playerOption)
});
$c_Lme_mfransen_Launcher$.prototype.$$js$exported$meth$kill__I__O = (function(player) {
  this.kill__I__V(player)
});
$c_Lme_mfransen_Launcher$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
$c_Lme_mfransen_Launcher$.prototype["launch"] = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$launch__Lorg_scalajs_dom_raw_MouseEvent__O(prep0)
});
$c_Lme_mfransen_Launcher$.prototype["prompt"] = (function(arg$1) {
  var prep0 = $uI(arg$1);
  return this.$$js$exported$meth$prompt__I__O(prep0)
});
$c_Lme_mfransen_Launcher$.prototype["kill"] = (function(arg$1) {
  var prep0 = $uI(arg$1);
  return this.$$js$exported$meth$kill__I__O(prep0)
});
$c_Lme_mfransen_Launcher$.prototype["addPlayer"] = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$addPlayer__Lorg_scalajs_dom_raw_MouseEvent__O(prep0)
});
var $d_Lme_mfransen_Launcher$ = new $TypeData().initClass({
  Lme_mfransen_Launcher$: 0
}, false, "me.mfransen.Launcher$", {
  Lme_mfransen_Launcher$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lme_mfransen_Launcher$.prototype.$classData = $d_Lme_mfransen_Launcher$;
var $n_Lme_mfransen_Launcher$ = (void 0);
function $m_Lme_mfransen_Launcher$() {
  if ((!$n_Lme_mfransen_Launcher$)) {
    $n_Lme_mfransen_Launcher$ = new $c_Lme_mfransen_Launcher$().init___()
  };
  return $n_Lme_mfransen_Launcher$
}
$e["me"] = ($e["me"] || {});
$e["me"]["mfransen"] = ($e["me"]["mfransen"] || {});
$e["me"]["mfransen"]["Launcher"] = $m_Lme_mfransen_Launcher$;
...
//# sourceMappingURL=game-of-risks-fastopt.js.map
